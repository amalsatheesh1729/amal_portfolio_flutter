...
class MobilePersonal extends StatefulWidget {
  const MobilePersonal({Key? key}) : super(key: key);

  @override
  State<MobilePersonal> createState() => _MobilePersonal();
}

class _MobilePersonal extends State<MobilePersonal> {
        ...
        body: Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    fit: BoxFit.cover,
                    image:NetworkImage('https://images.unsplash.com/photo-1518655048521-f130df041f66?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8cG9ydGZvbGlvJTIwYmFja2dyb3VuZHxlbnwwfHwwfHw%3D&w=1000&q=80'))
            ),
                        ...
                        children: [
                          ...
                          eachlist(
                              ...
                              'This was a learning project which I did with the help of google code labs. The basic idea was'
                                  ...
                                  'Stack : Flutter,Dart,Tensorflow Serving,REST,gRPC\n,TensorFlow Lite,googlecodelabs\n',
                              'Codelab',
                          ...
                          eachlist(
                              ...
                              'This is similar to above one. The few'
                                  ...
                                  ' Frontend: HTML,CSS,JavaScript,BootStrap,JQuery,SemanticUI\n'
                                  'API: REST\n'
